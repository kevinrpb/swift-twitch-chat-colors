...
let package = Package(
	...
	dependencies: [
		...
		.package(
			...
			from: "0.4.0"),
		.package(
			url: "https://github.com/hummingbird-project/hummingbird-fluent.git", branch: "main"),
		.package(url: "https://github.com/apple/swift-argument-parser.git", from: "1.5.0"),
		.package(
			url: "https://github.com/kevinrpb/swift-twitch-client.git",
			branch: "irc-return-continuation"),
	],
	targets: [
		.executableTarget(
			name: "App",
